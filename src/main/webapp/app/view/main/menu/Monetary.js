/**
 * Created by cai on 2014/9/20 16:40.
 *
 * 金额单位的管理类
 */
    ...
    statics: {
        ...
        getAllMonetary: function() {
            if (!this.values) {
                ...
                this.values.add('million', this.createAMonetary('百万', 100*10000, '百万元'));
                this.values.add('tenmillion', this.createAMonetary('千万', 1000*10000, '千万元'));
        ...
        createAMonetary: function(monetaryText, monetaryUnit, unitText) {
            return {
                monetaryText: monetaryText,     // 跟踪数值后面的金额单位文字，如：100.00万
                monetaryUnit: monetaryUnit,     // 显示数值需要除的分子
                unitText: unitText              // 更正字段后面的单位，如：合同金额（万元）
            }
        },

/**
 * Created by cai on 2014/9/21 18:43.
 *
 * 用于生成form中的每一个field
 * 这里省略了combo和选择父级字段属性的操作，只生成字符型，数值型，布尔型和日期型的内容
 */
Ext.define('app.view.module.factory.FormFieldFactory', {
    statics: {
        ...
        getField: function(fieldDefine, formField, formtype, module) {
            var field = {
                name: formField.tf_fieldName,
                fieldLabel: formField.fieldLabel || (formField.labelAhead ? formField.labelAhead : '')

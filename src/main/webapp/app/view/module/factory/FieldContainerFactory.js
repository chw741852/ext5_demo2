/**
 * Created by cai on 2014/9/21 17:14.
 *
 * 字段容器factory
 */
        ...
        getContainer: function(container, module, formtype) {
            ...
            for (var i in container) {
                ...
                if (field.spacer) {
                    ...
                    var f = app.view.module.factory.FormFieldFactory.getField(fieldDefine, field, formtype, module);
                    var c = {
                        xtype: 'fieldcontainer',
                        layout: (f.moduleName) ? (field.tf_width != -1 ? 'table' : 'hbox') : 'anchor',
